// ============================================
// CLOUDFLARE WORKER - real-estate-panel
// ============================================
...
export default {
    async fetch(request, env, ctx) {
        ...
        // ==========================================
        // API: UPLOAD IMAGE - نسخه اصلاح شده
        // ==========================================
        if (path === '/api/upload-image') {
            try {
                ...
                // تبدیل فایل به Base64 با روش استاندارد
                ...
                if (!uploadResponse.ok) {
                    ...
                    if (uploadResponse.status === 401) {
                        return new Response(JSON.stringify({
                            error: 'توکن گیت‌هاب نامعتبر یا منقضی شده است. لطفاً توکن جدید با دسترسی repo بسازید.',
                            details: errorText
                        }), {
                            status: 401,
                            headers: { ...corsHeaders, 'Content-Type': 'application/json' }
