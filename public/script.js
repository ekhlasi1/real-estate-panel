...
// ============================================
// COMMISSION CALCULATOR - اصلاح شده با فرمول صحیح
// ============================================
function calculateCommission() {
    ...
    // ۲. کمیسیون از مبلغ اجاره: دو سوم اجاره بها
    ...
    // ۶. سهم موجر و مستاجر (هر کدام نصف)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ====== PROPERTY FORM (با پشتیبانی از فروش/اجاره) ======
