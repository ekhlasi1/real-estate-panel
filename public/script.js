...
// ============================================
// UPLOAD IMAGE (support both file and URL)
// ============================================
...
// ============================================
// COMMISSION CALCULATOR - اصلاح شده
// ============================================
function calculateCommission() {
    ...
    // اگر عددی وارد نشده باشد یا NaN باشد، خطا بدهیم
    if (isNaN(rent)) {
        alert('لطفاً مبلغ رهن را به‌درستی وارد کنید (مبلغ باید عدد باشد)');
        rentInput.focus();
        return;
    }
    if (isNaN(monthly)) {
        alert('لطفاً مبلغ اجاره ماهانه را به‌درستی وارد کنید (مبلغ باید عدد باشد)');
        monthlyInput.focus();
        return;
    }

    // اجازه می‌دهیم مقدار ۰ معتبر باشد
    if (rent < 0) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (propForm) {
        propForm.addEventListener('submit', async function(e) {
            ...
            if (type === 'فروش') {
                const salePrice = document.getElementById('propSalePrice').value.replace(/,/g, '').trim();
                ...
                const rent = document.getElementById('propRentPrice').value.replace(/,/g, '').trim();
                const monthly = document.getElementById('propMonthlyPrice').value.replace(/,/g, '').trim();
