...
// ============================================
// RENDER PROPERTIES (با نمایش شماره مشاور)
// ============================================
        ...
        <div class="property-card" data-id="${p.id}">
            <div class="image-wrapper">
                ${p.images && p.images.length > 0
                    ...
                    : `<div style="height:100%;display:flex;align-items:center;justify-content:center;background:var(--secondary);">
                        <i class="fas fa-building" style="font-size:40px;color:var(--text-muted);"></i>
                       </div>`
                }
                ${p.videos && p.videos.length > 0 ? `<span class="video-icon"><i class="fas fa-video"></i> ویدئو</span>` : ''}
...
// ============================================
// TRACK PHONE CLICK (آمار تماس‌ها)
// ============================================
function trackPhoneClick(propertyId) {
    ...
    console.log(`📞 تماس با مشاور برای ملک ${propertyId} - تعداد: ${stats[propertyId]}`);
}
...
function updateStats() {
    ...
    document.querySelectorAll('#total-phone-clicks').forEach(el => {
